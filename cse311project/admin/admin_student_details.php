    ...
    <div class="sidebar">
      <h2>Admin Portal</h2>
        ...
        <div class="main_content">
          <div class="header">
            <h1 class="h1_welcome">Students</h1>
          </div>
            <div class="info">
              <div>
                <h2>
                    ...
                    <tbody>
                      <?php foreach ($student_reg as $reg): ?>
                        <tr>
                          ...
                          <td>
                            <button onclick="window.open('admin_student_edit.php?student_id=<?php echo $reg['student_id']; ?>', '_self')" <i class="fas fa-edit"></i>
                            </button>
                          </td>
                          <td>
                            <button onclick="window.open('admin_student_delete_db.php?student_id=<?php echo $reg['student_id']; ?>', '_self')" <i class="fas fa-trash-alt"></i>
                            </button>
                          </td>
                        </tr>
                      <?php endforeach; ?>
